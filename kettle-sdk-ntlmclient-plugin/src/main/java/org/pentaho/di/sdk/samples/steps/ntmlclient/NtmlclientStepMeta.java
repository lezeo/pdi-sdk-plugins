...
@Step(
    id = "NtmlclientStep",
    name = "NtmlclientStep.Name",
    description = "NtmlclientStep.TooltipDesc",
    image = "org/pentaho/di/sdk/samples/steps/ntmlclient/resources/demo.svg",
    categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input",
    i18nPackageName = "org.pentaho.di.sdk.samples.steps.ntmlclient",
    documentationUrl = "NtmlclientStep.DocumentationURL",
    casesUrl = "NtmlclientStep.CasesURL",
    forumUrl = "NtmlclientStep.ForumURL"
)
@InjectionSupported( localizationPrefix = "NtmlclientStepMeta.Injection." )
public class NtmlclientStepMeta extends BaseStepMeta implements StepMetaInterface {
    ...
    // Result parameters
    private String[] resultParamsName;
    private String[] resultParamsTargetName;
    ...
    public String[] getResultParamsName() {
        return resultParamsName;
    }

    public void setResultParamsName(String[] resultParamsName) {
        this.resultParamsName = resultParamsName;
    }

    public String[] getResultParamsTargetName() {
        return resultParamsTargetName;
    }

    public void setResultParamsTargetName(String[] resultParamsTargetName) {
        this.resultParamsTargetName = resultParamsTargetName;
    }
    ...
    public void allocate( int nrheaders, int nrparamers ) {
        allocate( nrheaders, nrparamers, 0, 0 );
    }

    public void allocate( int nrheaders, int nrparamers, int nrmatrixparameters, int nrResultParams ) {
        ...
        resultParamsName = new String[ nrResultParams ];
        resultParamsTargetName = new String[ nrResultParams ];
    }

    @Override
    public Object clone() {
        NtmlclientStepMeta retval = (NtmlclientStepMeta) super.clone();

        int nrheaders = headerName.length;
        int nrparameters = parameterField.length;
        int nrmatrixparameters = matrixParameterField.length;
        int nrResultParams = resultParamsName.length;

        retval.allocate( nrheaders, nrparameters, nrmatrixparameters, nrResultParams );
        System.arraycopy( headerField, 0, retval.getHeaderField(), 0, nrheaders );
        System.arraycopy( headerName, 0, retval.getHeaderName(), 0, nrheaders );
        System.arraycopy( parameterField, 0, retval.getParameterField(), 0, nrparameters );
        System.arraycopy( parameterName, 0, retval.getParameterName(), 0, nrparameters );
        System.arraycopy( matrixParameterField, 0, retval.getMatrixParameterField(), 0, nrmatrixparameters );
        System.arraycopy( matrixParameterName, 0, retval.getMatrixParameterName(), 0, nrmatrixparameters );
        System.arraycopy( resultParamsName, 0, retval.getResultParamsName(), 0, nrResultParams );
        System.arraycopy( resultParamsTargetName, 0, retval.getResultParamsTargetName(), 0, nrResultParams );
    ...
    public void getFields(
        ...
        if ( resultParamsTargetName.length > 0 ) {
            Arrays.stream( resultParamsTargetName ).forEach(it->{
    ...
    public String getXML() {
        ...
        retval.append("     <resultParams>").append( Const.CR );
        for ( int i = 0, len = ( resultParamsName != null ? resultParamsName.length : 0 ); i < len; i++ ) {
            retval.append( "      <resultParam>" ).append( Const.CR );
            retval.append( "        " ).append( XMLHandler.addTagValue( "name", resultParamsName[i] ) );
            retval.append( "        " ).append( XMLHandler.addTagValue( "targetName", resultParamsName[i] ) );
            retval.append( "        </resultParam>" ).append( Const.CR );
        }
        retval.append("     </resultParams>").append( Const.CR );
    ...
    private void readData( Node stepnode, List<? extends SharedObjectInterface> databases ) throws KettleXMLException {
        try {
            ...
            Node resultParamsNode = XMLHandler.getSubNode( stepnode, "resultParams" );
            int nrResultParams = XMLHandler.countNodes( resultParamsNode, "resultParam" );

            allocate( nrheaders, nrparameters, nrmatrixparameters, nrResultParams );
            ...
            for ( int i = 0; i < nrResultParams; i++ ) {
                Node node = XMLHandler.getSubNodeByNr( resultParamsNode, "resultParam", i );
                resultParamsName[i] = XMLHandler.getTagValue( node, "name" );
                resultParamsTargetName[i] = XMLHandler.getTagValue( node, "targetName" );
            }
    ...
    public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases ) throws KettleException {
        try {
            ...
            int nrResultParams = rep.countNrStepAttributes( id_step, "result_params_name" );
            allocate( nrheaders, nrparams, nrmatrixparams, nrResultParams );
            ...
            for ( int i = 0; i < nrResultParams; i++ ) {
                resultParamsName[i] = rep.getStepAttributeString( id_step, i, "result_params_name" );
                resultParamsTargetName[i] = rep.getStepAttributeString( id_step, i, "result_params_target_name" );
            }
    ...
    public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step ) throws KettleException {
        try {
            ...
            for ( int i = 0; i < resultParamsName.length; i++ ) {
                rep.saveStepAttribute( id_transformation, id_step, i, "result_params_name", resultParamsName[i] );
                rep.saveStepAttribute( id_transformation, id_step, i, "result_params_target_name", resultParamsTargetName[i] );
            }
    ...
    public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
        ...
        return new NtmlclientStep( stepMeta, stepDataInterface, cnr, transMeta, trans );
    }

    @Override
    public StepDataInterface getStepData() {
        return new NtmlclientStepData();
    }
